<html lang="en"><head>
    ...
    <title>Terms - AskAndExplore</title>
    <style>
        .about {
            max-width: 1300px;
            padding: 10px;
...
<div class="header">
    <a href="/">
        ...
        <p>Welcome to AskAndExplore!</p>

        <p>These terms and conditions outline the rules and regulations for the use of AskAndExplore's Website, located at
            AskAndExplore.</p>

        <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use
            AskAndExplore if you do not agree to take all of the terms and conditions stated on this page.</p>
        ...
        <p>We employ the use of cookies. By accessing AskAndExplore, you agreed to use cookies in agreement with
            the AskAndExplore's Privacy Policy. </p>
        ...
        <p>Unless otherwise stated, AskAndExplore and/or its licensors own the intellectual property rights for all
            material on AskAndExplore. All intellectual property rights are reserved. You may access this from
            AskAndExplore for your own personal use subjected to restrictions set in these terms and conditions.
        </p>

        <p>You must not:</p>
        <ul>
            <li>Republish material from AskAndExplore</li>
            <li>Sell, rent or sub-license material from AskAndExplore</li>
            <li>Reproduce, duplicate or copy material from AskAndExplore</li>
            <li>Redistribute content from AskAndExplore</li>
        </ul>

        <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain
            areas of the website. AskAndExplore does not filter, edit, publish or review Comments prior to their presence
            on the website. Comments do not reflect the views and opinions of AskAndExplore,its agents and/or affiliates.
            Comments reflect the views and opinions of the person who post their views and opinions. To the extent
            permitted by applicable laws, AskAndExplore shall not be liable for the Comments or for any liability, damages
        ...
        <p>AskAndExplore reserves the right to monitor all Comments and to remove any Comments which can be considered
        ...
        <p>You hereby grant AskAndExplore a non-exclusive license to use, reproduce, edit and authorize others to use,
        ...
        <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us look
            ...
            AskAndExplore; and (d) the link is in the context of general resource information.</p>
        ...
        <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website,
            you must inform us by sending an e-mail to AskAndExplore. Please include your name, your organization name,
        ...
        <p>No use of AskAndExplore's logo or other artwork will be allowed for linking absent a trademark license
            agreement.</p>
